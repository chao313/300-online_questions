...
import demomaster.vo.request.VQuestionFollowSumRequestUpdateBase;
import demomaster.vo.request.VQuestionFollowSumRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/VQuestionFollowSumController")
@Slf4j
public class VQuestionFollowSumController {

    @Autowired
    private VQuestionFollowSumService service;
    ...
    public Response insert(@RequestBody VQuestionFollowSumVo vo) {
    ...
    public Response insert(@RequestBody List<VQuestionFollowSumVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody VQuestionFollowSumVo query) {
        Response response = new Response();
        try {
            List<VQuestionFollowSumVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody VQuestionFollowSumVo query,
    ...
    public Response updateBase(@RequestBody VQuestionFollowSumRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody VQuestionFollowSumRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody VQuestionFollowSumVo vo) {
        Response response = new Response();
        try {
