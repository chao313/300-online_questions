...
import demomaster.vo.request.VAnswerUserRequestUpdateBase;
import demomaster.vo.request.VAnswerUserRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/VAnswerUserController")
@Slf4j
public class VAnswerUserController {

    @Autowired
    private VAnswerUserService service;
    ...
    public Response insert(@RequestBody VAnswerUserVo vo) {
    ...
    public Response insert(@RequestBody List<VAnswerUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody VAnswerUserVo query) {
        Response response = new Response();
        try {
            List<VAnswerUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody VAnswerUserVo query,
    ...
    public Response updateBase(@RequestBody VAnswerUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody VAnswerUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody VAnswerUserVo vo) {
        Response response = new Response();
        try {
