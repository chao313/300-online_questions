...
import demomaster.vo.request.TAnswerSecondRequestUpdateBase;
import demomaster.vo.request.TAnswerSecondRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TAnswerSecondController")
@Slf4j
public class TAnswerSecondController {

    @Autowired
    private TAnswerSecondService service;
    ...
    public Response insert(@RequestBody TAnswerSecondVo vo) {
    ...
    public Response insert(@RequestBody List<TAnswerSecondVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TAnswerSecondVo query) {
        Response response = new Response();
        try {
            List<TAnswerSecondVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TAnswerSecondVo query,
    ...
    public Response updateBase(@RequestBody TAnswerSecondRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TAnswerSecondRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TAnswerSecondVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(String id) {
        Response response = new Response();
        try {
            TAnswerSecondVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TAnswerSecondRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
