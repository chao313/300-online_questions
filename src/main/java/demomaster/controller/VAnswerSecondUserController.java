...
import demomaster.vo.request.VAnswerSecondUserRequestUpdateBase;
import demomaster.vo.request.VAnswerSecondUserRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/VAnswerSecondUserController")
@Slf4j
public class VAnswerSecondUserController {

    @Autowired
    private VAnswerSecondUserService service;
    ...
    public Response insert(@RequestBody VAnswerSecondUserVo vo) {
    ...
    public Response insert(@RequestBody List<VAnswerSecondUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody VAnswerSecondUserVo query) {
        Response response = new Response();
        try {
            List<VAnswerSecondUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody VAnswerSecondUserVo query,
    ...
    public Response updateBase(@RequestBody VAnswerSecondUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody VAnswerSecondUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody VAnswerSecondUserVo vo) {
        Response response = new Response();
        try {
