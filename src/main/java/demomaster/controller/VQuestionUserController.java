...
import demomaster.vo.request.VQuestionUserRequestUpdateBase;
import demomaster.vo.request.VQuestionUserRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/VQuestionUserController")
@Slf4j
public class VQuestionUserController {

    @Autowired
    private VQuestionUserService service;
    ...
    public Response insert(@RequestBody VQuestionUserVo vo) {
    ...
    public Response insert(@RequestBody List<VQuestionUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody VQuestionUserVo query) {
        Response response = new Response();
        try {
            List<VQuestionUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody VQuestionUserVo query,
    ...
    public Response updateBase(@RequestBody VQuestionUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody VQuestionUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody VQuestionUserVo vo) {
        Response response = new Response();
        try {
