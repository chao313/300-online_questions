...
import demomaster.vo.request.TAdminUserRequestUpdateBase;
import demomaster.vo.request.TAdminUserRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TAdminUserController")
@Slf4j
public class TAdminUserController {

    @Autowired
    private TAdminUserService service;
    ...
    public Response insert(@RequestBody TAdminUserVo vo) {
    ...
    public Response insert(@RequestBody List<TAdminUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TAdminUserVo query) {
        Response response = new Response();
        try {
            List<TAdminUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TAdminUserVo query,
    ...
    public Response updateBase(@RequestBody TAdminUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TAdminUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TAdminUserVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(String id) {
        Response response = new Response();
        try {
            TAdminUserVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TAdminUserRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
