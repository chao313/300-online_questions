...
import demomaster.vo.request.VHotQuestionRequestUpdateBase;
import demomaster.vo.request.VHotQuestionRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/VHotQuestionController")
@Slf4j
public class VHotQuestionController {

    @Autowired
    private VHotQuestionService service;
    ...
    public Response insert(@RequestBody VHotQuestionVo vo) {
    ...
    public Response insert(@RequestBody List<VHotQuestionVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody VHotQuestionVo query) {
        Response response = new Response();
        try {
            List<VHotQuestionVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody VHotQuestionVo query,
    ...
    public Response updateBase(@RequestBody VHotQuestionRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody VHotQuestionRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody VHotQuestionVo vo) {
        Response response = new Response();
        try {
