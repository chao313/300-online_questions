...
import demomaster.vo.request.TTagRequestUpdateBase;
import demomaster.vo.request.TTagRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TTagController")
@Slf4j
public class TTagController {

    @Autowired
    private TTagService service;
    ...
    public Response insert(@RequestBody TTagVo vo) {
    ...
    public Response insert(@RequestBody List<TTagVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TTagVo query) {
        Response response = new Response();
        try {
            List<TTagVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TTagVo query,
    ...
    public Response updateBase(@RequestBody TTagRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TTagRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TTagVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(String id) {
        Response response = new Response();
        try {
            TTagVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TTagRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
