...
import demomaster.vo.request.TReportQuestionRequestUpdateBase;
import demomaster.vo.request.TReportQuestionRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TReportQuestionController")
@Slf4j
public class TReportQuestionController {

    @Autowired
    private TReportQuestionService service;
    ...
    public Response insert(@RequestBody TReportQuestionVo vo) {
    ...
    public Response insert(@RequestBody List<TReportQuestionVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TReportQuestionVo query) {
        Response response = new Response();
        try {
            List<TReportQuestionVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TReportQuestionVo query,
    ...
    public Response updateBase(@RequestBody TReportQuestionRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TReportQuestionRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TReportQuestionVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(String id) {
        Response response = new Response();
        try {
            TReportQuestionVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TReportQuestionRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
