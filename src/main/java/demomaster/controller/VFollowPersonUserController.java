...
import demomaster.vo.request.VFollowPersonUserRequestUpdateBase;
import demomaster.vo.request.VFollowPersonUserRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/VFollowPersonUserController")
@Slf4j
public class VFollowPersonUserController {

    @Autowired
    private VFollowPersonUserService service;
    ...
    public Response insert(@RequestBody VFollowPersonUserVo vo) {
    ...
    public Response insert(@RequestBody List<VFollowPersonUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody VFollowPersonUserVo query) {
        Response response = new Response();
        try {
            List<VFollowPersonUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody VFollowPersonUserVo query,
    ...
    public Response updateBase(@RequestBody VFollowPersonUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody VFollowPersonUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody VFollowPersonUserVo vo) {
        Response response = new Response();
        try {
