...
import demomaster.vo.request.VReportUserUserRequestUpdateBase;
import demomaster.vo.request.VReportUserUserRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/VReportUserUserController")
@Slf4j
public class VReportUserUserController {

    @Autowired
    private VReportUserUserService service;
    ...
    public Response insert(@RequestBody VReportUserUserVo vo) {
    ...
    public Response insert(@RequestBody List<VReportUserUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody VReportUserUserVo query) {
        Response response = new Response();
        try {
            List<VReportUserUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody VReportUserUserVo query,
    ...
    public Response updateBase(@RequestBody VReportUserUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody VReportUserUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody VReportUserUserVo vo) {
        Response response = new Response();
        try {
