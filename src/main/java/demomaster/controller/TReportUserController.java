...
import demomaster.vo.request.TReportUserRequestUpdateBase;
import demomaster.vo.request.TReportUserRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TReportUserController")
@Slf4j
public class TReportUserController {

    @Autowired
    private TReportUserService service;
    ...
    public Response insert(@RequestBody TReportUserVo vo) {
    ...
    public Response insert(@RequestBody List<TReportUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TReportUserVo query) {
        Response response = new Response();
        try {
            List<TReportUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TReportUserVo query,
    ...
    public Response updateBase(@RequestBody TReportUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TReportUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TReportUserVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(String id) {
        Response response = new Response();
        try {
            TReportUserVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TReportUserRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
