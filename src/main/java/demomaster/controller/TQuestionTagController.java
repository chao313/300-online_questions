...
import demomaster.vo.request.TQuestionTagRequestUpdateBase;
import demomaster.vo.request.TQuestionTagRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TQuestionTagController")
@Slf4j
public class TQuestionTagController {

    @Autowired
    private TQuestionTagService service;
    ...
    public Response insert(@RequestBody TQuestionTagVo vo) {
    ...
    public Response insert(@RequestBody List<TQuestionTagVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TQuestionTagVo query) {
        Response response = new Response();
        try {
            List<TQuestionTagVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TQuestionTagVo query,
    ...
    public Response updateBase(@RequestBody TQuestionTagRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TQuestionTagRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TQuestionTagVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(String id) {
        Response response = new Response();
        try {
            TQuestionTagVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TQuestionTagRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
