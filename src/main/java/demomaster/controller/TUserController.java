...
import demomaster.vo.request.TUserRequestUpdateBase;
import demomaster.vo.request.TUserRequestUpdatePrimaryKey;
...
public class TUserController {
    ...
    public Response insert(@RequestBody TUserVo vo) {
        Response response = new Response();
        try {
            String passwd = EncryptUtil.getInstance().Base64Encode(vo.getPassword());//取出加密的数据
    ...
    public Response insert(@RequestBody List<TUserVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TUserVo query) {
        Response response = new Response();
        try {
            List<TUserVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TUserVo query,
    ...
    public Response updateBase(@RequestBody TUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TUserRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TUserVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(String name) {
        Response response = new Response();
        try {
            TUserVo result = service.queryByPrimaryKey(name);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response deleteByPrimaryKey(String name) {
        Response response = new Response();
        try {
            Boolean result = service.deleteByPrimaryKey(name);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TUserRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
